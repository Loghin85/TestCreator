class UsersController < ApplicationController
  ...
  def create
    ...
    if verify_recaptcha(model: @user) && @user.save  
			...
			assessment.save
			Question.new({"assessment_id"=>assessment.id, "Title"=>"Question 1", "Text"=>"<p>Which of the following is not an animal?</p>", "Feedback"=>"<p>Unfortunately, Banana is not an animal.</p>", "Type"=>"MCQ", "Points"=>"10", "Options"=>"NEG0", "Answer"=>"〔Bear〕0%〔Banana〕100%〔Dolphin〕0%〔Moneky〕0%",}).save
