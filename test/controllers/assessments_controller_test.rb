...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { Description: @assessment.Description, Duration: @assessment.Duration, Name: @assessment.Name, ScheduledAt: @assessment.ScheduledAt, UserId: @assessment.UserId } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { Description: @assessment.Description, Duration: @assessment.Duration, Name: @assessment.Name, ScheduledAt: @assessment.ScheduledAt, UserId: @assessment.UserId } }
